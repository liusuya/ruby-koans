...
class AboutClassMethods < Neo::Koan
  ...
  class Dog
    ...
    def a_simple_class_method
      :dogs_simple_class_method
    end
  end
  ...
  def test_you_can_define_class_methods_inside_the_class
    ...
    assert_raise(NoMethodError) do
      Dog.a_simple_class_method
    end
    toto = Dog.new
    assert_equal :dogs_simple_class_method, toto.a_simple_class_method
  end
  ...
  # my current hypothesis depends on how far away the method is from the class. cuz in the second
  # example, it might be difficult to discern whether its a class or instance method if that def
  # is far from the `class << self`. on the other hand, if all the methods are class methods, the self.
  # might become too redundant
  #
  ...
  # ohhhh so to call a class method from an instance, you need to do
