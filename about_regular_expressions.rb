...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    assert_equal "bb", "bbcccddddeeeee"[/[ab]*/]
    assert_equal "a", "abbcccddddeeeee"[/az*/]
  ...
  def test_slash_z_anchors_to_the_end_of_the_string
    ...
    assert_equal nil, "start end\n"[/end\z/]
    assert_equal 'end', "start end\n"[/end\Z/]
    assert_equal nil, "start end\nstart2 end2\n"[/end\Z/]
    assert_equal 'end', "start end\nstart2 end2\n"[/end$/]
  ...
  def test_a_vertical_pipe_means_or
    ...
    # weird... if you put in a 1, it treats the string as a space delimited array
  ...
  def test_scan_is_like_find_all
    ...
    assert_equal ["one", "two_three"], "one two_three".scan(/\w+/)
  end

  def test_sub_is_like_find_and_replace
    # /(t\w*)/ returns "two". and then you get 1 charater starting from index 0, and that's the substitution value
